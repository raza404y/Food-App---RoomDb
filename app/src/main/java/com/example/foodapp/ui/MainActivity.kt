...
class MainActivity : AppCompatActivity() {
    ...
    private fun setData(list: ArrayList<FoodModel>) {
        ...
        list.add(FoodModel(R.drawable.img_11, "Noodle", 3, "Chinese Noodle available with 50% discount."))
        ...
        list.add(FoodModel(R.drawable.img_6, "Muffin", 11, "Muffin is available with 20% discount."))
        list.add(FoodModel(R.drawable.img_7, "Burrito", 9, "Most famous Burger is available with 20% discount."))
        list.add(FoodModel(R.drawable.img_8, "Taco", 5, "Mexico Tacos are available with 20% discount."))
